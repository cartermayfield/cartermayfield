...
My main project: an end-to-end automated trading system for in-play professional tennis on two regulated exchanges (**Kalshi** and **Polymarket US**). The repo is private — it runs live capital and a proprietary strategy — but I'm happy to walk through any part of it in depth.
...
The short version: I falsified 70 strategies to find the ones worth deploying, and the system has been profitable in live trading since.
...
**DevOps & Cloud:** Docker · GitHub Actions · AWS (CloudFormation, ECR, ECS, EC2) · Git
**Data & ML:** pandas · NumPy · scikit-learn · XGBoost · Optuna · PyArrow/Parquet
